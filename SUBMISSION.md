...
## One-line pitch
Cookie Alpha Radar turns Cookie Chain market data into explainable signals and lets users stamp any signal on-chain as a verifiable watch proof.

## What makes it different
- Not a passive dashboard: discovery ends in a real, confirmed Cookie Chain transaction.
- Explainable scoring: no opaque AI score.
...
9. Show CookieSwap and bridge links.
